...
>
  ...
  {/* Dropdown */}
  <div
    className={`absolute left-0 mt-4 w-72 bg-white 
  ...
  >
    ...
    <Link
      ...
      className="group flex items-start gap-4 p-4 rounded-t-2xl 
      bg-white text-gray-800 
      hover:bg-[#1a3c2e] hover:text-white 
      transition-all duration-200"
    >
      <div className="w-12 flex items-center justify-center bg-yellow-50 rounded-xl 
    ...
    <Link
      ...
      className="group flex items-start gap-4 p-4 rounded-b-2xl 
      bg-white text-gray-800 
      hover:bg-[#1a3c2e] hover:text-white 
      transition-all duration-200"
    >
      <div className="w-12 flex items-center justify-center bg-green-50 rounded-xl 
      group-hover:scale-105 transition">
        <Image
          src="/icon/save2.jpeg"
          alt="Simpanan"
